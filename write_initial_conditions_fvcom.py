...
# lllowe@ncsu.edu
#Purpose:
# Writes CGEM initial conditions files DETRITUS_INI_X.dat based on cgem.nml.
#Use:
# Copy this file to the directory with a sample DETRITUS_INI_X.dat file
#  for your grid, along with cgem.nml. From that directory, do:
